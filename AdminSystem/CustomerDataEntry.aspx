...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtCustomerID" runat="server" style="z-index: 1; left: 162px; top: 54px; position: absolute" width="128px" OnTextChanged="txtCustomerID_TextChanged"></asp:TextBox>
        <asp:Label ID="lblCustomerName" runat="server" style="z-index: 1; left: 24px; top: 89px; position: absolute; width: 179px;" Text="Customer name"></asp:Label>
        ...
        <asp:Label ID="lblCustomerPassowrd" runat="server" style="z-index: 1; left: 28px; top: 159px; position: absolute; right: 1214px" Text="Customer password"></asp:Label>
        ...
        <asp:TextBox ID="txtPassword" runat="server" style="z-index: 1; left: 235px; top: 163px; position: absolute" width="128px"></asp:TextBox>
        ...
        <p>
        <asp:TextBox ID="txtName" runat="server" style="z-index: 1; left: 228px; top: 84px; position: absolute" width="128px"></asp:TextBox>
        </p>
        <p>
        <asp:TextBox ID="txtEmail" runat="server" style="z-index: 1; left: 209px; top: 121px; position: absolute; right: 1111px; margin-top: 0px;" width="128px"></asp:TextBox>
        </p>
        <p>
